...
@section('content')
    ...
    <section class="bg-surface pt-28 pb-16 lg:pt-32 lg:pb-20 section-padding !py-0 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 pt-28 pb-16 lg:pt-32 lg:pb-20 relative z-10">
            <div class="max-w-2xl">
                <h1 class="animate-fade-in-up font-display text-4xl sm:text-5xl lg:text-display-lg lg:text-[4rem] leading-[1.05] text-on-surface mb-6">
                    Daftar Harga
    ...
    <section class="bg-surface section-padding !pt-0 !pb-8">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-surface-container-lowest rounded-lg overflow-hidden ambient-shadow">
                ...
                <div class="price-row flex flex-col md:grid md:grid-cols-12 gap-4 px-6 py-6 md:px-8 {{ $loop->even ? 'bg-surface-container-low hover:bg-surface-container' : 'bg-surface hover:bg-surface-container-low' }} transition-all duration-200 group" data-category="{{ \Illuminate\Support\Str::slug($service->device_model) }}">
                    <div class="md:col-span-3 flex items-center gap-4">
                        ...
                        <span class="text-title-md text-on-surface font-semibold">{{ $service->service_name }}</span>
                    </div>
                    <div class="md:col-span-6 flex flex-col justify-center">
                        ...
                        <div class="mt-2">
                            <span class="inline-block text-xs font-semibold px-2.5 py-1 rounded-sm bg-surface-container-highest text-on-surface-variant">
                                {{ $service->device_model }}
                            </span>
                        </div>
                        @endif
                    </div>
                    <div class="md:col-span-3 flex items-center justify-between md:justify-end gap-4 mt-2 md:mt-0">
                        <span class="md:hidden text-xs font-semibold text-on-surface-variant/70 uppercase tracking-wider">Harga Mulai</span>
                        <span class="inline-flex items-center px-4 py-1.5 rounded-sm bg-primary-container/20 text-primary font-bold text-sm">
    ...
    <section class="bg-surface section-padding !py-16">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-gradient-primary-subtle rounded-lg px-8 py-10 md:px-12 md:py-12 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <a href="https://wa.me/{{ preg_replace('/^0/', '62', \App\Models\Setting::get('whatsapp', '085728160180')) }}" target="_blank" class="btn-white flex-shrink-0">
