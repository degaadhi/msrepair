...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 animate-fade-in-up">
    <!-- Card 1 -->
    <div class="bg-surface-container-lowest p-8 rounded-xl flex items-center justify-between group hover:bg-primary/5 transition-colors duration-300 shadow-sm border border-outline-variant/10">
        <div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-surface-container-lowest border-b border-outline-variant/10">
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-on-surface-variant">Device Model</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-on-surface-variant">Service</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-on-surface-variant text-right">Price</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-outline-variant/10">
                    @forelse ($latestPrices as $price)
                    <tr class="hover:bg-surface-container-low transition-colors">
                        <td class="px-6 py-4 text-sm font-medium text-on-surface">{{ $price->device_model ?? '-' }}</td>
                        <td class="px-6 py-4 text-sm text-on-surface-variant">{{ $price->service_name }}</td>
                        <td class="px-6 py-4 text-sm font-bold text-primary text-right">Rp {{ number_format($price->price, 0, ',', '.') }}</td>
                    </tr>
                    @empty
                    <tr>
    ...
    <div class="bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm border border-outline-variant/10">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-surface-container-lowest border-b border-outline-variant/10">
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-on-surface-variant">Repair Case</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-on-surface-variant">Technician</th>
                        <th class="px-6 py-4 text-xs font-bold uppercase tracking-wider text-on-surface-variant text-right">Status</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-outline-variant/10">
                    ...
                    <tr class="hover:bg-surface-container-low transition-colors">
                        ...
                        <td class="px-6 py-4 text-sm text-on-surface-variant">{{ $portfolio->technician ?? '-' }}</td>
