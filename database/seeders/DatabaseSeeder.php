...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $portfolios = [
            ['title' => 'iPhone 14 Internal Realignment', 'caption' => 'Restored factory structural integrity after chassis compression.', 'category' => 'Internal / Logic Board', 'technician' => 'Ari S.', 'completion_date' => '2023-10-24', 'status' => 'completed', 'visibility' => 'public'],
            ['title' => 'Organic LED Panel Swap', 'caption' => 'Zero-pixel defect calibration for ProMotion display series.', 'category' => 'Display Repair', 'technician' => 'Dimas W.', 'completion_date' => '2023-10-21', 'status' => 'in_progress', 'visibility' => 'public'],
            ['title' => 'Microsoldering Recovery', 'caption' => 'Successful trace restoration on water-damaged logic board.', 'category' => 'Internal / Logic Board', 'technician' => 'Siska K.', 'completion_date' => '2023-10-18', 'status' => 'completed', 'visibility' => 'public'],
        ];
